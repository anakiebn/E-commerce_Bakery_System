...
<html>
    ...
    <body>
        <div class="container">
            <form class="address-form" action="PaymentAddAddressServlet" method="POST">
                <%
                    User user =(User)session.getAttribute("user");
                %>
                <h2>Hi <%=user.getUserName()%>, please add your Delivery Address</h2> 
                ...
                <!--<a href="Payment.jsp" >Add Address</a>-->
