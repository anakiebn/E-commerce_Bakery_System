<%-- 
    Document   : Login
    Created on : Jun 1, 2023, 1:17:11 PM
    Author     : Train
--%>
  ...
  <div class="container">
    <form class="login-form" action="LoginServlet" method="POST">
      ...
      <% String str = (String)request.getAttribute("msg");
         if(str!=null){
      %>
       <p style="color:Tomato;"> <%=str%> </p><%}%>
      Email Address:
      <input type="text" name="emailaddress" placeholder="EmailAddress" required>
      Password:
      ...
      <div class="register-link">
        <p>New User? <a href=http://localhost:8080/BakerySystem/Register.jsp>Register here</a></p>
      </div>
    </form>
