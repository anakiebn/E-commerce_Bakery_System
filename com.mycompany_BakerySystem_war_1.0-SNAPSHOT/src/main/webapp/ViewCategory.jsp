    ...
    <body>
        <div class="container">
            ...
            <div class="view-category-form">
                ...
                <div class="search-bar">
                    <input type="text" id="searchInput" placeholder="Search Category" oninput="searchCategory()">
                </div>
                <p>


                    <%
                        List<Category> catList = (List<Category>) request.getAttribute("cate");
                    %>
                ...
                <table>
                    <tr>
                        ...
                        <th> <button onclick="showAddCategoryPopup()">Add Category</button></th>
                    </tr>
                   
                        <% for (Category category : catList) {%>
                        <tr>
                            <td><%= category.getCategoryName()%></td>
                            <td><%= category.isIsActive()%></td>
                            <td><button onclick="updateCategory('<%= category.getCategoryId()%>', '<%= category.getCategoryName()%>')">Update</button></td>
                            <%if (category.isIsActive()) {%>
                            <td><button onclick="restoreCategory('<%= category.getCategoryId()%>')">Deactivate</button></td>
                            <%} else {%>
                            <td><button onclick="deleteCategory('<%= category.getCategoryId()%>')">Activate</button></td>
                            <%}%>
        ...
        <script>
                    ...
                    function updateCategory(categoryId, currentName) {
                        var newName = prompt("Enter the new category name", currentName);
